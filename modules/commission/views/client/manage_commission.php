      ...
      <div class="row">
        <div class="panel_s section-heading section-tickets">
          <div class="panel-body">
            <h4 class="no-margin section-text"><?php echo _l('commission'); ?></h4>
          </div>
        </div>
          <div class="panel_s">
             <div class="panel-body">
                 <div class="row">
                     <div class="col-md-4 border-right">
                      ...
                      <hr />
                      <p><a href="#" class="font-medium" onclick="init_report(this,'commission_client_table'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('commission_table'); ?></a></p>
                     </div>
                    <div class="col-md-4 border-right">
                      <h4 class="no-margin font-medium"><i class="fa fa-area-chart" aria-hidden="true"></i> <?php echo _l('charts_based_report'); ?></h4>
                      <hr />
                      <p><a href="#" class="font-medium" onclick="init_report(this,'commission_client_chart'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('commission_chart'); ?></a></p>
                   </div>
                   <div class="col-md-4">
            ...
            <div id="report" class="hide">
                <div class="col-md-12">
                    <?php $this->load->view('client/commission_table'); ?>
                </div>
                <div class="col-md-12">
                    <?php $this->load->view('client/commission_chart'); ?>
                </div>
              </div>
            </div>      
          </div>
...
<?php require 'modules/commission/assets/js/manage_commission_client_js.php';?>