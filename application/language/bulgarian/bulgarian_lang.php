...
$lang ['driving_zone'] = 'Шофьорска зона';
$lang ['google_calendar'] = 'Google Календар';
$lang ['edit_item'] = 'Редактиране на автомобил';

$lang ['Vehicle_Make'] = 'Автомобилна марка';
$lang ['Vehicle_Model'] = 'Модел на превозното средство';
$lang ['Vehicle_Type'] = 'Тип превозно средство';
$lang ['Number_Of_Passengers'] = 'Брой пътници';
$lang ['Extra_Time_Enable'] = 'Активиране на допълнително време';
$lang ['Base_Location'] = 'Основно местоположение';
$lang ['Vehicle_Availability_Enable'] = 'Наличност на превозно средство';
$lang ['Price_Type_Variable'] = 'Тип на цената';
$lang ['Number_Of_Suitcases'] = 'Брой куфари';
$lang ['DEFAULT_CATEGORY_VEHICLE'] = 'ПРЕВОЗНО СРЕДСТВО ЗА КАТЕГОРИЯ ПО подразбиране';
$lang ['ENABLE'] = 'АКТИВИРАНЕ';
$lang ['DISABLE'] = 'DISABLE';
$lang ['VEHICLE_TYPE'] = 'ТИП НА ПРЕВОЗНОТО СРЕДСТВО';
$lang ['vehicle_type'] = 'тип превозно средство';
$lang ['vehicle_type'] = 'тип превозно средство';
$lang ['VEHICLE_MAKE'] = 'ПРАВЕНЕ НА АВТОМОБИЛ';
$lang ['vehicle_make'] = 'марка на превозното средство';
$lang ['VEHICLE_MODEL'] = 'МОДЕЛ НА ПРЕВОЗНО СРЕДСТВО';
$lang ['vehicle_model'] = 'модел на превозното средство';
$lang ['NUMBER_OF_PASSENGERS'] = 'БРОЙ ПЪТНИЦИ';
$lang ['nop_exp'] = 'Максимален брой пътници (или места). Цяло число от 1 до 99 ';
$lang ['NUMBER_OF_SUITCASES'] = 'БРОЙ КУФАРИ';
$lang ['nos_exp'] = 'Максимален брой куфари. Цяло число от 1 до 99 ';
$lang ['EXTRA_TIME'] = 'ДОПЪЛНИТЕЛНО ВРЕМЕ';
$lang ['et_exp'] = 'Изберете дали искате да предложите опцията за допълнително време (в часове).
Тази опция е достъпна само за дистанционни и фиксирани услуги. ';
$lang ['et_exp1'] = 'Посочете минималното (целочислена стойност от 0 до 9999) и максималното (целочислена стойност от 1 до 9999) допълнително време в часове.';
$lang ['step1_9999'] = 'Стъпка (целочислена стойност от 1 до 9999):';
$lang ['BASE_LOCATION'] = 'БАЗНО ЛОКАЦИЯ';
$lang ['be_exp'] = 'Основно местоположение на компанията. Ако е настроен, разходите за пътуване от базовото местоположение до мястото за вземане ще бъдат добавени към сумата от
поръчката. Тази опция не е налична за тип услуга с фиксирана ставка. ';
$lang ['VEHICLES_AVAILABILITY'] = 'НАЛИЧНОСТ НА ПРЕВОЗНИ СРЕДСТВА';
$lang ['va_exp'] = 'Активира опцията, ако искате да предотвратите изпращането на поръчки, които съдържат
превозни средства, добавени към други поръчки със същата дата / час на пътуването. ';
$lang['BOOKINGS_INTERVAL'] = 'ИНТЕРВАЛ ЗА РЕЗЕРВИРАНЕ';
$lang['bi_exp'] = 'Задаване на интервал (в минути) между резервации, които съдържат едно и също превозно средство.';
$lang['FIXED_LOCATIONS'] = 'ФИКСИРАНИ МЕСТОПОЛОЖЕНИЯ';
$lang['fl_exp'] = 'Въведете фиксирано място за взимане / предаване за избрана услуга.';
$lang['Service'] = 'Услуга';
$lang['Pickup_location'] = 'Място за вземане';
$lang['Drop_off_location'] = 'Място за отпътуване';
$lang['Разстояние'] = 'Разстояние';
$lang['Почасово'] = 'Почасово';
$lang['PRICE_TYPE'] = 'ТИП ЦЕНА';
$lang['pt_exp'] = 'Изберете тип цена. <br>
За променлива цена крайната цена на пътуването зависи от разстоянието или времето.
За фиксирани цени крайната цена на пътуването е независима от разстоянието или времето. ';
$lang['Variable_pricing'] = 'Променливо ценообразуване';
$lang['Fixed_pricing'] = 'Фиксирано ценообразуване';
$lang['PRICES'] ='ЦЕНИ';
$lang['pr_exp'] = 'Нетни цени.';
$lang['Name'] = 'Име';
$lang['Type'] = 'Тип';
...
$lang['ATTRIBUTES'] = 'АТРИБУТИ';
$lang['att_exp'] = 'Посочете атрибутите на превозното средство.';
$lang['Attribute_name'] = 'Име на атрибута';
$lang['Attribute_value'] = 'Стойност на атрибута';
$lang['Drivers_Language'] = 'Език на драйверите';
$lang['Meee_Greet_included'] = 'Включени срещи и поздрави';
$lang['EXCLUDE_DATES'] = 'ИЗКЛЮЧВАНЕ НА ДАТИТЕ';
$lang['ed_exp'] = 'Посочете дати, в които превозното средство не е налично. Миналите (или невалидните периоди от време) ще бъдат премахнати по време на запазването. ';
$lang['Start_Date_Time'] = 'Начална дата и час';
$lang['End_Date_Time'] = 'Час на крайната дата';
$lang['Remove'] = 'Премахване';
$lang['BUSINESS_HOURS'] = 'БИЗНЕС ЧАСОВЕ';
$lang['bh_exp'] = 'Посочете работни дни / часове. <br>
Оставете всички полета празни, ако резервацията не е налична за избрания ден. <br> ';
$lang['Weekday'] = 'Делничен ден';
...
$lang['cntr_exp'] = 'Изберете държави, в които клиентът може да постави места за пътуване (точки).
Поради ограниченията на API на Google, можете да настроите до 5 такива държави. ';
$lang['CUSTOM_DRIVING_ZONE'] = 'ПОТРЕБИТЕЛНА ЗОНА ЗА ШОФИРАНЕ';
$lang['cdz_exp'] = 'За да създадете своя собствена зона с ограничено пътуване, нарисувайте фигура с помощта на инструмент, разположен в горната част на картата.
За да започнете да модифицирате или създавате нова област, трябва да премахнете предварително дефинираната форма. ';
$lang['GOOGLE_CALENDAR'] = 'КАЛЕНДАР НА GOOGLE';
$lang ['gce_exp'] = 'Активирайте или деактивирайте интеграцията с Google Календар.';
